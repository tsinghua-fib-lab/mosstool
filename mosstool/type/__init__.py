...
from pycityproto.city.map.v2.map_pb2 import Aoi, AoiType, Lane, LaneTurn, LaneType, Map
...
from pycityproto.city.routing.v2.routing_pb2 import Journey, JourneyType, DrivingJourneyBody
